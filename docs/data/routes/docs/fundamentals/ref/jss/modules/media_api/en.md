...
[Sitecore JavaScript Rendering SDK](/docs/fundamentals/ref/jss/) / media-api
...
- [findEditorImageTag](/docs/fundamentals/ref/jss/modules/media_api#findeditorimagetag)
- [getRequiredParams](/docs/fundamentals/ref/jss/modules/media_api#getrequiredparams)
- [getSrcSet](/docs/fundamentals/ref/jss/modules/media_api#getsrcset)
- [updateImageUrl](/docs/fundamentals/ref/jss/modules/media_api#updateimageurl)
