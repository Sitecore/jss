...
* `[templates/nextjs-sxa]` In nextjs-sxa components has been changed Image to NextImage component of JSS lib for optimization ([#1843](https://github.com/Sitecore/jss/pull/1843))
