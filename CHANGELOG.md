...
- Patch: no breaking changes, no new features / Eg. Bug fixes, minor improvement
- Minor: can include breaking changes in framework packages / Framework upgrades / new features/improvements
- Major: can include breaking changes in core packages / Major architectural changes / Major features
