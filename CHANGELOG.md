...
* `[sitecore-jss-dev-tools]` getMetadata() now uses package-lock json to get the exact versions of packages. this solution works for monorepo setups ([#1949](https://github.com/Sitecore/jss/pull/1949))
