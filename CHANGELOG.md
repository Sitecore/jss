...
* `[sitecore-jss-nextjs]` `[templates/nextjs-multisite]` Optionally add attributes to the `sc_site` cookie: `secure`, `httpOnly`, `expires`, `sameSite` ([#1746](https://github.com/Sitecore/jss/pull/1746))
