...
* `[sitecore-jss-cli]` Code extraction feature for XMCloud code generation is added ([#2075](https://github.com/Sitecore/jss/pull/2075))
...
* `[create-sitecore-jss]` Fix DesignLibrary component being rendered when XMCloud source is not selected ([#2089](https://github.com/Sitecore/jss/pull/2089))
