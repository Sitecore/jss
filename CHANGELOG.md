...
* `[create-sitecore-jss]``[sitecore-jss-angular]``[template/angular-xmcloud]` Angular SXA components
  * Angular SXA Richtext component ([#1864](https://github.com/Sitecore/jss/pull/1864))
  * Angular SXA Container component ([#1872](https://github.com/Sitecore/jss/pull/1872))
