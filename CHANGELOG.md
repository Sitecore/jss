...
* `[templates/nextjs-sxa]` Scaffolding components for BYOC is added. Use '--byoc' flag at the end of jss scaffold command to create a component with registration that can be used for BYOC ([#1572](https://github.com/Sitecore/jss/pull/1572))
