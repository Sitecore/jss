...
- [propTypes](index.BYOCComponent.md#proptypes)
...
The snapshot is only present if [getSnapshotBeforeUpdate](index.BYOCComponent.md#getsnapshotbeforeupdate) is present and returns non-null.
