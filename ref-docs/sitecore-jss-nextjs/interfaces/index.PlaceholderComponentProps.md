...
• **rendering**: [`RouteData`](index.RouteData.md)<`Record`<`string`, [`Field`](index.Field.md)<`GenericFieldValue`\> \| [`Item`](index.Item.md) \| [`Item`](index.Item.md)[]\>\> \| [`ComponentRendering`](index.ComponentRendering.md)
...
| `data` | ([`HtmlElementRendering`](index.HtmlElementRendering.md) \| [`ComponentRendering`](index.ComponentRendering.md))[] |
