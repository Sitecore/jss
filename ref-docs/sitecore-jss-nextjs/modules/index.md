...
- [CacheClient](../interfaces/index.CacheClient.md)
- [CacheOptions](../interfaces/index.CacheOptions.md)
...
[sitecore-jss-nextjs/src/ComponentBuilder.ts:20](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/ComponentBuilder.ts#L20)
...
[sitecore-jss-nextjs/src/sharedTypes/component-props.ts:9](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/sharedTypes/component-props.ts#L9)
...
[sitecore-jss-nextjs/src/components/ComponentPropsContext.tsx:26](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/components/ComponentPropsContext.tsx#L26)
...
[sitecore-jss-nextjs/src/sharedTypes/component-props.ts:4](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/sharedTypes/component-props.ts#L4)
...
[sitecore-jss-nextjs/src/sharedTypes/component-props.ts:25](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/sharedTypes/component-props.ts#L25)
...
[sitecore-jss-nextjs/src/sharedTypes/component-props.ts:30](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/sharedTypes/component-props.ts#L30)
...
Ƭ **GraphQLSiteInfoServiceConfig**: [`CacheOptions`](../interfaces/index.CacheOptions.md) & \{ `clientFactory`: [`GraphQLRequestClientFactory`](graphql.md#graphqlrequestclientfactory) ; `pageSize?`: `number`  }
...
[sitecore-jss-nextjs/src/components/Link.tsx:12](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/components/Link.tsx#L12)
...
[sitecore-jss-nextjs/src/sharedTypes/module-factory.ts:7](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/sharedTypes/module-factory.ts#L7)
...
[sitecore-jss-nextjs/src/sharedTypes/module-factory.ts:34](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/sharedTypes/module-factory.ts#L34)
...
Ƭ **RestDictionaryServiceConfig**: [`CacheOptions`](../interfaces/index.CacheOptions.md) & \{ `apiHost`: `string` ; `apiKey`: `string` ; `dataFetcher?`: [`HttpDataFetcher`](index.md#httpdatafetcher)\<`RestDictionaryServiceData`\> ; `siteName`: `string`  }
...
[sitecore-jss-nextjs/src/components/RichText.tsx:10](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/components/RichText.tsx#L10)
...
[sitecore-jss-nextjs/src/context/context.ts:6](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/context/context.ts#L6)
...
[sitecore-jss-nextjs/src/services/graphql-sitemap-service.ts:31](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/services/graphql-sitemap-service.ts#L31)
...
[sitecore-jss-nextjs/src/components/ComponentPropsContext.tsx:7](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/components/ComponentPropsContext.tsx#L7)
...
[sitecore-jss-nextjs/src/components/ComponentPropsContext.tsx:31](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/components/ComponentPropsContext.tsx#L31)
...
[sitecore-jss-nextjs/src/components/Placeholder.tsx:15](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/components/Placeholder.tsx#L15)
...
[sitecore-jss-nextjs/src/components/RichText.tsx:27](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/components/RichText.tsx#L27)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `renderingOrFields` | [`ComponentFields`](../interfaces/index.ComponentFields.md) \| [`ComponentRendering`](../interfaces/index.ComponentRendering.md)\<[`ComponentFields`](../interfaces/index.ComponentFields.md)\> | the rendering or fields object to extract the field from |
...
| Name | Type |
| :------ | :------ |
| `renderingOrFields` | [`ComponentFields`](../interfaces/index.ComponentFields.md) \| [`ComponentRendering`](../interfaces/index.ComponentRendering.md)\<[`ComponentFields`](../interfaces/index.ComponentFields.md)\> |
| `fieldName` | `string` |
| `defaultValue` | `T` |
...
[sitecore-jss-nextjs/src/components/ComponentPropsContext.tsx:15](https://github.com/Sitecore/jss/blob/892e6d1a5/packages/sitecore-jss-nextjs/src/components/ComponentPropsContext.tsx#L15)
