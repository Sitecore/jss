...
[sitecore-jss-angular/src/components/render-each.directive.ts:7](https://github.com/Sitecore/jss/blob/8d5d9ef1a/packages/sitecore-jss-angular/src/components/render-each.directive.ts#L7)
