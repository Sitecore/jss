...
[sitecore-jss-angular/src/components/render-each.directive.ts:7](https://github.com/Sitecore/jss/blob/8de6d3f6b/packages/sitecore-jss-angular/src/components/render-each.directive.ts#L7)
