...
[sitecore-jss-angular/src/components/placeholder.token.ts:65](https://github.com/Sitecore/jss/blob/92d4e00cd/packages/sitecore-jss-angular/src/components/placeholder.token.ts#L65)
...
[sitecore-jss-angular/src/components/rendering.ts:6](https://github.com/Sitecore/jss/blob/92d4e00cd/packages/sitecore-jss-angular/src/components/rendering.ts#L6)
