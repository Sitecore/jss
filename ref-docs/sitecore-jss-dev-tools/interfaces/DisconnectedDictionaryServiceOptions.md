...
[disconnected-server/dictionary-service.ts:33](https://github.com/Sitecore/jss/blob/4e03c287a/packages/sitecore-jss-dev-tools/src/disconnected-server/dictionary-service.ts#L33)
...
[disconnected-server/dictionary-service.ts:32](https://github.com/Sitecore/jss/blob/4e03c287a/packages/sitecore-jss-dev-tools/src/disconnected-server/dictionary-service.ts#L32)
...
[disconnected-server/dictionary-service.ts:39](https://github.com/Sitecore/jss/blob/4e03c287a/packages/sitecore-jss-dev-tools/src/disconnected-server/dictionary-service.ts#L39)
