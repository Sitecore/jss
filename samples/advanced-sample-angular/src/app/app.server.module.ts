...
import { JssTranslationServerLoaderService } from './jss-translation-server-loader.service';
...
@NgModule({
  imports: [
    ...
    TranslateModule.forRoot({ // <-- *Important* to get translation values server-sde
      loader: {
