...
/**
 * This is a standalone _base template_ that is inherited by components in the company that need to
...
export default function(manifest) {
  manifest.addTemplate({
    name: 'JssVueWeb-Company-Explanatory-Component',
    id: 'JssVueWeb-company-explanatory-component-template',
    fields: [
