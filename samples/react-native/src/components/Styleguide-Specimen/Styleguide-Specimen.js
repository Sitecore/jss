	...
	return (
		<View style={styles.wrapper}>
			...
			<NText style={styles.section}>
				Implementation: <NText style={styles.filepath}>/src/components/{rendering.componentName}/index.js</NText>
			</NText>
			<NText style={styles.section}>
				Definition:{' '}
				<NText style={styles.filepath}>/sitecore/definitions/components/{rendering.componentName}.sitecore.js</NText>
			</NText>
