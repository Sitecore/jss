...
import { sscAuthMockBefore, sscAuthMockContext } from './sitecore-context-authentication-mock';
import { navigationMockContext } from './sitecore-context-navigation-mock';
...
const customizeContext = (defaultContext, route, manifest, request, response) => {
  const user = sscAuthMockContext(request);
