...
export default defineComponent({
  ...
  setup(props) {
    ...
    const variables = () => {
      ...
      const variables = {
        contextItem: ssrInitialState?.sitecoreContext ? ssrInitialState.sitecoreContext.itemId : defaultValue,
        datasource: (props.rendering && props.rendering.dataSource) || defaultValue,
        language: useState('language')?.value || config.defaultLanguage
      };
