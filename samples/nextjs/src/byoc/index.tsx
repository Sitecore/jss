...
import { sitecoreConfig as config } from '@sitecore-jss/sitecore-jss-nextjs';
import {
...
const BYOCInit = (): JSX.Element | null => {
  ...
  const edgeConfig = config?.client.xmcloud;
  FEAAS.setContextProperties({
    sitecoreEdgeUrl: edgeConfig.sitecoreEdgeUrl,
    sitecoreEdgeContextId: edgeConfig.sitecoreEdgeContextId,
