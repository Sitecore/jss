...
const StyleguideLayout = (props: ComponentProps): JSX.Element => {
  ...
  const sections = getChildPlaceholder(props.rendering, 'NextjsApp-jss-styleguide-layout')
    ...
    .map((section) => ({
      ...
      children: getChildPlaceholder(getRendering(section), 'NextjsApp-jss-styleguide-section')
  ...
  return (
    <div className="row">
      <div className="col-sm-8 col-lg-10">
        <Placeholder name="NextjsApp-jss-styleguide-layout" rendering={props.rendering} />
      </div>
