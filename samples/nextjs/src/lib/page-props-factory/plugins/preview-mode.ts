  ...
  async exec(props: SitecorePageProps, context: GetServerSidePropsContext | GetStaticPropsContext) {
    ...
    if (isComponentLibraryPreviewData(context.previewData)) {
      ...
      const componentService = new RestComponentLayoutService({
        apiHost: sitecoreConfig.client.local!.sitecoreApiHost || '123',
        apiKey: sitecoreConfig.client.local!.sitecoreApiKey || '123',
        siteName: site,
        configurationName: sitecoreConfig.layoutServiceConfigurationName,
      });
