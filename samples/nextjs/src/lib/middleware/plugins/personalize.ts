  ...
  constructor() {
    ...
    this.personalizeMiddleware = new PersonalizeMiddleware({
      ...
      cdpConfig: {
        ...
        sitecoreEdgeContextId: xmcConfig?.sitecoreEdgeContextId || '123',
        timeout:
      ...
      scope: sitecoreConfig.middleware.personalize.scope,
      // This function determines if the middleware should be turned off.
      // IMPORTANT: You should implement based on your cookie consent management solution of choice.
      // You may wish to keep it disabled while in development mode.
      disabled: sitecoreConfig.middleware.personalize.disabled,
