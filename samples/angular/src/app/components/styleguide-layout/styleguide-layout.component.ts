...
export class StyleguideLayoutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.navigation = getChildPlaceholder(this.rendering, 'JssAngularWeb-styleguide-layout')
      ...
      .map((section: ComponentRendering) => ({
        ...
        children: getChildPlaceholder(section, 'JssAngularWeb-styleguide-section')
