...
const AppRoot = ({ path, Router, graphQLClient, ssrState, contextFactory }) => {
  ...
  const routeRenderFunction = (props) => <RouteHandler route={props} ssrState={ssrState} contextFactory={contextFactory} />;
  return (
