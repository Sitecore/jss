...
describe('RedirectsMiddleware', () => {
  ...
  describe('redirects middleware - getHandler', () => {
    ...
    describe('should redirect to normalized path when nextjs specific "path" query string parameter is provided', () => {
      ...
      describe('escapeNonSpecialQuestionMarks integration', () => {
        it('should handle patterns with literal question marks correctly', async () => {
          const cloneUrl = () => Object.assign({}, req.nextUrl);
          const url = {
            clone: cloneUrl,
            href: 'http://localhost:3000/found',
          ...
          const { res, req } = createTestRequestResponse({
            ...
            request: {
              nextUrl: {
                pathname: '/not-found',
                search: '?param=value',
                href: 'http://localhost:3000/not-found?param=value',
                locale: 'en',
                origin: 'http://localhost:3000',
                clone: cloneUrl,
              },
        ...
        it('should handle regex patterns with question marks unchanged', async () => {
          const cloneUrl = () => Object.assign({}, req.nextUrl);
          const url = {
            clone: cloneUrl,
            href: 'http://localhost:3000/found',
        ...
        it('should handle patterns with multiple question marks', async () => {
          ...
          const { res, req } = createTestRequestResponse({
            ...
            request: {
              nextUrl: {
                ...
                href: 'http://localhost:3000/not-found?param1=value1&param2=value2',
                locale: 'en',
                origin: 'http://localhost:3000',
                clone: cloneUrl,
              },
          ...
          const { finalRes, fetchRedirects, siteResolver } = await runTestWithRedirect(
            {
              pattern: '/not-found?param1=value1&param2=value2',
              target: '/found',
              redirectType: REDIRECT_TYPE_301,
              isQueryStringPreserved: true,
              locale: 'en',
