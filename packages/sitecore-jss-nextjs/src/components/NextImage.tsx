...
export const NextImage: React.FC<NextImageProps> = ({
  ...
  // disable image optimization for Edit / Preview rendering, but preserve original value if true
  const unoptimized =
    otherProps.unoptimized || sitecoreContext.context?.pageState !== LayoutServicePageState.Normal;
