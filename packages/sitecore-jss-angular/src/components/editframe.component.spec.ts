...
import { DefaultEditFrameButton, EditButtonTypes, EditFrameDataSource } from '@sitecore-jss/sitecore-jss/utils';
...
@Component({
  ...
  describe('<EditFrame />', () => {
    ...
    it('should render the datasource', () => {
      ...
      expect(frameSpan.textContent).toContain('"contextItemUri":"sitecore://master/testItemId?lang=en"');
    });
    ...
    it('should render the buttons', () => {
      ...
      "commands":
        ...
        "type":null}
      ]`.replace(/(\r\n|\n|\r|[\s]{2,})/gm, ""));  // ensure expected output is readable for both human and runtime
    });
  });
