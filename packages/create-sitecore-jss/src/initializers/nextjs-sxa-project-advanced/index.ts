...
export default class NextjsSXAProjectAdvancedInitializer implements Initializer {
  get isBase(): boolean {
    return false;
  }
  ...
  async init(args: ClientAppArgs) {
    ...
    const templatePath = path.resolve(__dirname, '../../templates/nextjs-sxa-project-advanced');
