 ...
 */
function generateComponentFactoryCreator(components: (PackageDefinition | ComponentFile | Project)[]): string {
  ...
  const projects = components.filter(component => (component as Project).projectName) as Project[];
...
export default generateComponentFactoryCreator;
