...
- `XM Cloud proxy personalization` with embedded personalization and Component A/B Testing support (with [XM CLoud Proxy applicaiton](#Running-the-application-in-production-mode)).
