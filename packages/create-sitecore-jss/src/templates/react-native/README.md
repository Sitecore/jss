...
The basic sample for React Native is based on a project created via the Expo CLI, e.g. `expo init`

We have tested the basic sample app on the following configurations:

- Windows / Android
  - In this configuration, testing was done using a physical device connected using Expo app via QR code.
- macOS / iOS
  - In this configuration, testing was done using a physical device connected using Expo app via QR code.

## Getting Started

1. Ensure you have completed the Prerequisites section and have confirmed you're able to run the sample that the instructions direct you to create.

1. At this point, you can follow the JSS Quick Start guide: https://doc.sitecore.com/xp/en/developers/hd/200/sitecore-headless-development/walkthrough--getting-started-with-jss-for-react-native.html
