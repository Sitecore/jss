...
describe('<FEaaSComponent />', () => {
  ...
  it('should render when fallback server props provided', () => {
    ...
    expect(wrapper.html()).to.equal(
      '<feaas-component class="-feaas" cdn="host123" library="library123" version="version123" component="component123" revision="staged" hydrate="false"></feaas-component>'
    );
  });
  ...
  it('should render with template when provided', () => {
    ...
    expect(wrapper).to.have.length(1);
    expect(wrapper.html()).to.equal(
      `<feaas-component class="-feaas" hydrate="false">${template}</feaas-component>`
    );
  });
