...
describe('updateImageUrl', () => {
  it('should override parameters with those provided', () => {
    const original = 'http://sitecore/-/media/lorem.png?h=1&w=2&mh=3&mw=4hash=CC5043DC03C6C27F40EDB08CF84AB8670C05D63D';
  ...
  it('should merge querystring and params', () => {
    const src = '/media/lorem/ipsum.jpg?x=valueX&rev=109010';
    const params = { y: 'valueY', z: 'valueZ' };
    const parsed = updateImageUrl(src, params);
    const url = URL(parsed, {}, true);

    expect(url.toString()).equal('/media/lorem/ipsum.jpg?x=valueX&y=valueY&z=valueZ&rev=109010')
...
describe('getSrcSet', () => {
  it('should create a srcset for all provided widths', () => {
    ...
    const expected = '/ipsum.jpg?h=1000&w=1000 1000w, /ipsum.jpg?h=500&w=500 500w, /ipsum.jpg?mh=250&mw=250 250w';
    const params = [
      { h: '1000', w: '1000' },
      { h: '500', w: '500' },
      { mh: '250', mw: '250' },
